$(function(){
    ...
    function initFlot(){
        ...
        function _initChart(){
            var plot = $.plotAnimator($chart, [{
                ...
                label: "Male",
                data: data3,
                points: { show: true, fill: true, radius:6,fillColor:"#88C4EE",lineWidth:3 },
                color: '#fff',
                shadowSize:0
            },{
                label: "Female",
                ...
                label: "Male",
                data: data2,
                points: { show: true, fill: true, radius:6,fillColor:"#F7653F",lineWidth:3 },
                color: '#fff',
                shadowSize:0
            }],{
                xaxis: {
    ...
    function initSparkline2(){
        $('#sparkline2').sparkline([2,4,6],{
            ...
            width: '100px',
            height: '100px',
            sliceColors: ['#88C4EE', '#F7653F', '#f0f0f0']
        });
    }
    ...
    function initNvd31(){
        ...
        nv.addGraph(function() {
            ...
            d3.select('#nvd31 svg')
                .style('height', '300px')
                .datum(testData(['Female', 'Male'], 50).map(function(el, i){
                    el.area = true;
                    return el;
                }))
...
//            chart.controls.margin({left: 0});
            ...
            d3.select('#nvd32 svg')
                .style('height', '300px')
                .datum(testData(['Female', 'Male'], 10).map(function(el, i){
                    el.area = true;
                    return el;
                }))
                .transition().duration(500)
